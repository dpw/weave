...
func TestShortIDInvalidation(t *testing.T) {
	...
	requireInvalidatedShortIDs := func(expect bool) {
		require.Equal(t, expect, pending.invalidatedShortIDs)
		pending.invalidatedShortIDs = false
	}
	...
	requireInvalidatedShortIDs(false)
	...
	requireInvalidatedShortIDs(true)
